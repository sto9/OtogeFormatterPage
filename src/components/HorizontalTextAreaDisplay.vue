    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <div class="relative">
          <textarea
            id="input-multi-yoko"
            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-lg resize-none bg-gray-50 hover:border-gray-300"
